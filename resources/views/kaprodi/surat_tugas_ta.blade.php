...
<head>
    ...
    <title>Surat Tugas Sidang Tugas Akhir</title>
    <style>
        body {
...
<body>
    ...
    <h2>SURAT TUGAS</h2>
    <p style="text-align: center;">Nomor: 772/PL9.5/TA/{{ now()->format('Y') }}</p>
    ...
    <table>
        ...
        <tbody>
            <tr>
                <td>1</td>
                <td>{{ $ketua_sidang }}</td>
                <td>{{ $nidn_ketua_sidang ?? 'N/A' }}</td>
                <td>Ketua Sidang</td>
            </tr>
            <tr>
                <td>2</td>
                <td>{{ $penguji1 }}</td>
                <td>{{ $nidn_penguji1 ?? 'N/A' }}</td>
                <td>Dosen Penguji 1</td>
            </tr>
            <tr>
                <td>3</td>
                <td>{{ $penguji2 }}</td>
                <td>{{ $nidn_penguji2 ?? 'N/A' }}</td>
                <td>Dosen Penguji 2</td>
            </tr>
            <tr>
                <td>4</td>
                <td>{{ $penguji3 }}</td>
                <td>{{ $nidn_penguji3 ?? 'N/A' }}</td>
                <td>Dosen Penguji 3</td>
            </tr>
        </tbody>
    </table>

    <p>Untuk melaksanakan Sidang Tugas Akhir Mahasiswa yang disebut di bawah ini:</p>
    <table>
